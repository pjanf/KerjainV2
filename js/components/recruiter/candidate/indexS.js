					...
					<View style={styles.content}>
					    ...
					    <Card style={{marginTop : 5, marginBottom : 5}}>
							...
							<ListItem itemDivider style={{paddingLeft:22, paddingTop:6, paddingBottom:6, paddingRight:6}}>
					            ...
					            <Right>
					            	<Text style={{color: '#d35400', fontSize:8}}>Accepted</Text>
					            </Right>
							</ListItem>
							...
							<ListItem style={styles.listItem} style={{alignSelf : 'center'}}>
					            ...
					            onPress={() => Alert.alert('Arrange the interview', '2018-08-30', [{text:'OK', onPress: () => this.props.navigation.navigate("Candidate")}, {text:'Cancel', style:'cancel'}], 'plain-text') }>
						        	<Text>Interview</Text>
						        </Button>
