...
import { Image, StatusBar, Switch, Share, Alert, TouchableOpacity} from "react-native";
		        ...
		        <Content style={styles.container}>
					...
					<Card bordered style={{backgroundColor : '#E0E0E0', paddingLeft : 10, paddingRight : 10}}>
						<List dataArray={datas} renderRow={(data) =>
							<TouchableOpacity>
					          	<CardItem button style={{marginTop : 5, marginBottom : 5, paddingBottom : 10}} onPress={() => this.props.navigation.navigate("CandidateS")}>
